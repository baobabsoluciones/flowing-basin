...
import flowing_basin.rl_zoo.rl_zoo3.import_envs  # noqa: F401
from flowing_basin.rl_zoo.rl_zoo3.callbacks import SaveVecNormalizeCallback, TrialEvalCallback
from flowing_basin.rl_zoo.rl_zoo3.hyperparams_opt import HYPERPARAMS_SAMPLER
from flowing_basin.rl_zoo.rl_zoo3.utils import ALGOS, get_callback_list, get_class_by_name, get_latest_run_id, get_wrapper_class, linear_schedule
...
class ExperimentManager:
    ...
    def read_hyperparameters(self) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        elif self.env_name.gym_id.startswith("RLEnvironment-"):
            hyperparams = hyperparams_dict["RLEnvironment-ANY"]
        elif self._is_atari:
    ...
    def objective(self, trial: optuna.Trial) -> float:
        ...
        additional_args = {
            ...
            "her_kwargs": kwargs.get("replay_buffer_kwargs", {}), "continuous_actions": self.continuous_actions,
        }
