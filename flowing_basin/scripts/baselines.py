...
if __name__ == "__main__":
    ...
    csv_instance_final_values(['MILP', 'PSO', 'PSO-RBO', 'rl-greedy'], solvers_best=['PSO', 'PSO-RBO'])
    csv_instance_final_values(['MILP', 'PSO', 'PSO-RBO', 'rl-greedy'], solvers_best=['PSO', 'PSO-RBO'], reference='rl-greedy')
    # csv_instance_final_timestamps(['MILP', 'PSO'])
