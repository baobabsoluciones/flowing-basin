...
# rl = ReinforcementLearning("A113G0O2R1T13", verbose=2)
...
# ReinforcementLearning.print_max_avg_incomes(regex, permutation='GATOR', baselines=["MILP", "Heuristic", "rl-greedy", "rl-random"])
