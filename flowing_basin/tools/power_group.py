...
class PowerGroup:
    def __init__(
        ...
        if mode == "nonlinear":
            ...
            try:
                ...
                raise Exception("You must install lightgbm package when mode is nonlinear.")
    ...
    @staticmethod
    def get_nonlinear_power_model(path_power_model: str):
        ...
        :return: a lightgbm.LGBMClassifier
        """
    ...
    def update(self, price: float, past_flows: np.ndarray, time: int) -> np.ndarray:
