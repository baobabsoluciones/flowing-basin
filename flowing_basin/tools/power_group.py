...
class PowerGroup:
    ...
    def get_power(self, flows_over_time: deque) -> float:
        ...
        :param flows_over_time: Flows assigned in the previous time steps to the channel (m3/s)
        :return: Power generated in this time step (MW)
        """
    ...
    def get_turbined_flow(self, flows_over_time: deque) -> float:
        ...
        :param flows_over_time: Flows assigned in the previous time steps to the preceding channel (m3/s)
        :return: Turbined flow in this time step (m3/s)
        """
    ...
    def update(self, flows_over_time: deque) -> float:
        ...
        :param flows_over_time: Flows assigned in the previous time steps to the preceding channel (m3/s)
        :return: Turbined flow in the power group (m3/s)
        """
